...
class DealTest(unittest.TestCase):
	...
	def test_play_all_actions_with_sidepot(self):
		self.test_deal.players[0].chips = 200
		self.test_deal.players[1].chips = 400
		self.test_deal.players[2].chips = 600
		self.test_deal.initiate_round()
		self.test_deal.update_player_with_action(0, ['call'])
		self.test_deal.update_player_with_action(1, ['call'])
		self.test_deal.update_player_with_action(2, ['call'])
		self.test_deal.play_all_actions(0)
		self.test_deal.clean_up_betting_round()
		self.assertEqual(self.test_deal.pot, 6)
		self.assertFalse(any([player.all_in for player in self.test_deal.players]))
		self.test_deal.update_player_with_action(1, ['bet', 10])
		self.test_deal.update_player_with_action(2, ['call'])
		self.test_deal.update_player_with_action(0, ['raise', 188])	
		self.assertTrue(self.test_deal.players[0].all_in)
		self.test_deal.update_player_with_action(1, ['call'])
		self.test_deal.update_player_with_action(2, ['call'])
		self.test_deal.play_all_actions(0)
		self.test_deal.clean_up_betting_round()
		self.test_deal.update_player_with_action(1, ['bet', 100])
		self.test_deal.update_player_with_action(2, ['raise', 100])
		self.test_deal.update_player_with_action(1, ['call'])
		self.assertTrue(self.test_deal.players[1].all_in)
		self.test_deal.play_all_actions(0)
		self.test_deal.clean_up_betting_round()
		self.assertFalse(self.test_deal.players[2].sidepot)
		self.assertEquals(self.test_deal.players[0].sidepot, 600)
		self.assertEquals(self.test_deal.players[1].sidepot, 1000)
		self.clean_up(players_by_rank = [
			self.test_deal.players[0],
			self.test_deal.players[1],
			self.test_dael.players[2]])
		self.assertEquals(self.test_deal.players[0].chips, 600)
		self.assertEquals(self.test_deal.players[1].chips, 400)
		self.assertEquals(self.test_deal.players[2].chips, 200)

	def test_play_all_actions_with_sidepot_2(self):
		self.test_deal.players[0].chips = 1000
		self.test_deal.players[1].chips = 2000
		self.test_deal.players[2].chips = 3000
		self.test_deal.players.append(Player(4000, 'Dave'))
		self.test_deal.players.append(Player(5000, 'Elliot'))
		self.test_deal.players.append(Player(6000, 'Frank'))
		self.test_deal.players.append(Player(7000, 'Garret'))
		self.test_deal.initiate_round()
		self.test_deal.update_player_with_action(3, ['call'])
		self.test_deal.update_player_with_action(4, ['call'])
		self.test_deal.update_player_with_action(5, ['call'])
		self.test_deal.update_player_with_action(6, ['call'])
		self.test_deal.update_player_with_action(0, ['raise', 998])
		self.test_deal.update_player_with_action(1, ['call'])
		self.test_deal.update_player_with_action(2, ['call'])
		self.test_deal.update_player_with_action(3, ['call'])
		self.test_deal.update_player_with_action(4, ['call'])
		...
		self.test_deal.play_all_actions(0)
		self.test_deal.clean_up_betting_round()
		self.assertEqual(self.test_deal.players[0].sidepot, 7000)
		self.test_deal.update_player_with_action(1, ['bet', 1000])
		self.test_deal.update_player_with_action(2, ['call'])
		self.test_deal.update_player_with_action(3, ['call'])
		self.test_deal.update_player_with_action(4, ['call'])
		self.test_deal.update_player_with_action(5, ['call'])
		...
		self.assertEqual(self.players[1].sidepot, 13000)
		self.test_deal.update_player_with_action(2, ['bet', 1000])
		self.test_deal.update_player_with_action(3, ['call'])
		self.test_deal.update_player_with_action(4, ['call'])
		self.test_deal.update_player_with_action(5, ['call'])
		self.test_deal.update_player_with_action(6, ['call'])
		self.test_deal.play_all_actions(0)
		self.clean_up_betting_round()
		self.assertEqual(self.players[2].sidepot, 18000)
		self.test_deal.update_player_with_action(3, ['bet', 1000])
		self.test_deal.update_player_with_action(4, ['raise', 1000])
		self.test_deal.update_player_with_action(5, ['call'])
		self.test_deal.update_player_with_action(6, ['fold'])
		self.test_deal.play_all_actions(0)
		self.assertEqual(self.players[3].sidepot, 21000)
		self.assertEqual(self.players[4].sidepot, 23000)
		self.clean_up(players_by_rank = [self.test_deal.players[1],
			self.test_deal.players[3], self.test_deal.players[2],
			self.test_deal.players[0], self.test_deal.players[4],
			self.test_deal.players[5]])
		self.assertEquals(self.test_deal.players[0].chips, 0)
		self.assertEquals(self.test_deal.players[1].chips, 13000)
		self.assertEquals(self.test_deal.players[2].chips, 0)	
		self.assertEquals(self.test_deal.players[3].chips, 8000)
		self.assertEquals(self.test_deal.players[4].chips, 2000)
		self.assertEquals(self.test_deal.players[5].chips, 1000)
		self.assertEquals(self.test_deal.players[6].chips, 4000)
		self.assertEquals(sum([player.chips for player in self.test_deal.players]), 28000)
